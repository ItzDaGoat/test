...
export const Welcome = () => {
    return (
        <div className=" relative h-5/6  pt-24">
            <main className=" relative  h-[40rem]  mx-auto max-w-7xl   px-4   ">
                <video autoPlay loop muted className="absolute top-0 right-10 h-[35rem] w-[50rem]">
                ...
                <div className="relative py-10   sm:text-center lg:text-left  w-8/12    flex  flex-col  justify-start  ">
                    <div className="mb-8 my-3 ">
                        ...
                        <div className="my-5 cursor-default tracking-tight text-8xl italic  font-bold  text-purple-600    "></div>
                    </div>
